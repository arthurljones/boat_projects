...
class ProjectServicesControllerTest < ActionController::TestCase
  ...
  test "should create project_service" do
    assert_difference('ProjectService.count') do
      post :create, project_service: { project_id: @project_service.project_id, quantity: @project_service.quantity, service_id: @project_service.service_id }
    end
  ...
  test "should update project_service" do
    put :update, id: @project_service, project_service: { project_id: @project_service.project_id, quantity: @project_service.quantity, service_id: @project_service.service_id }
    assert_redirected_to project_service_path(assigns(:project_service))
  end
